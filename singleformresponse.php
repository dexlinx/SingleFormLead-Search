...
//Get chunks of X Number of leads and Locate Lead ID
//-------------------------------------------------------------
$offset = 0;

do{
	
	$currentLeads = apiCall($apiKey,'GET','leads/lead?rf[]=email&rf[]=id&offset='.$offset.'&limit=350',$data);
	$offset+=350; //<- Limit and Offset Determine Number of leads per loop
